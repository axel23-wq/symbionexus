...
export default function ContractsPage() {
  ...
  const MOCK_CONTRACTS = [
    ...
    },
    {
      ...
      buyerCompany: { name: 'NAMé Recycling' },
    ...
    },
    {
      id: 'ctr-3',
      status: 'SIGNED',
      match: { listing: { title: 'Biomasse Agricole (Cacao)' } },
      sellerCompany: { name: 'Coopérative Sanaga' },
      buyerCompany: { name: 'AGROCAM' },
      sellerCompanyId: 'comp-2',
      volumeEngagedKg: 20000,
      pricePerKg: 150,
      totalPrice: 3000000,
      durationMonths: 12,
      sellerSigned: true,
    ...
    },
    {
      id: 'ctr-4',
      status: 'DRAFT',
      match: { listing: { title: 'Huiles de Moteur Usagées' } },
      sellerCompany: { name: 'Garage Moderne' },
      buyerCompany: { name: 'Groupe Bocom' },
      sellerCompanyId: 'comp-other',
      volumeEngagedKg: 800,
      pricePerKg: 200,
      totalPrice: 160000,
    ...
    },
    {
      id: 'ctr-5',
      status: 'COMPLETED',
      match: { listing: { title: 'Ferraille de Construction' } },
      sellerCompany: { name: 'BTP Cameroun' },
      buyerCompany: { name: 'PROMETAL' },
      sellerCompanyId: 'comp-3',
      volumeEngagedKg: 50000,
      pricePerKg: 250,
      totalPrice: 12500000,
      durationMonths: 1,
      sellerSigned: true,
    ...
    },
    {
      id: 'ctr-6',
      status: 'SIGNED',
      match: { listing: { title: 'Déchets Organiques Municipaux' } },
      sellerCompany: { name: 'Commune Douala 1er' },
      buyerCompany: { name: 'HYSACAM' },
      sellerCompanyId: 'comp-other',
      volumeEngagedKg: 100000,
      pricePerKg: 25,
      totalPrice: 2500000,
      durationMonths: 24,
      sellerSigned: true,
    ...
    },
    {
      id: 'ctr-7',
      status: 'IN_PROGRESS',
      match: { listing: { title: 'Boues Industrielles' } },
      sellerCompany: { name: 'Brasseries du Cameroun' },
      buyerCompany: { name: 'SECA' },
      sellerCompanyId: 'comp-4',
      volumeEngagedKg: 15000,
      pricePerKg: 100,
      totalPrice: 1500000,
      durationMonths: 6,
      sellerSigned: true,
    ...
    },
    {
      id: 'ctr-8',
      status: 'PENDING_SIGNATURES',
      match: { listing: { title: 'Verre Cassé (Calcin)' } },
      sellerCompany: { name: 'Sources du Pays' },
      buyerCompany: { name: 'Socamab' },
      sellerCompanyId: 'comp-user', // Current user's company so they can sign
      volumeEngagedKg: 5000,
      pricePerKg: 80,
      totalPrice: 400000,
      durationMonths: 1,
    ...
    },
    {
      id: 'ctr-9',
      status: 'SIGNED',
      match: { listing: { title: 'Emballages Carton Corrugué' } },
      sellerCompany: { name: 'Supermarchés DOVV' },
      buyerCompany: { name: 'Papeterie Nationale' },
      sellerCompanyId: 'comp-user',
      volumeEngagedKg: 3000,
      pricePerKg: 120,
      totalPrice: 360000,
      durationMonths: 3,
      sellerSigned: true,
